...
def calculate_object_width(center_object, neighboring_object):
    ...
    print("Center centroid: ", center_centroid)
        ...
        if os.path.exists(label_path):
            ...
            with open(label_path, 'r') as f:
                ...
                for line in f:
                    ...
                    if real_category in parking_categories:
                        calculate_parking_space_width(annotation)
                        center_annotation = annotation

                    result[image_filename].append(annotation)
                for detection in result[image_filename]:
